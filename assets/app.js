...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    var m = mx || crumb.textContent.match(/Researcher session (\d+) of 10/);
    if (m) {
      var current = parseInt(m[1], 10);
      var pages = mx
        ? ["a1-what-ai-changes.html", "a2-evidence-quality.html", "a3-where-ai-fails.html", "a4-governance-and-consent.html", "a5-the-research-stack.html", "a6-deciding-on-evidence.html"]
        : ["b1-researchers-ai-loop.html", "b2-question-and-claims.html", "b3-search-and-source-tiering.html", "b4-screening-at-scale.html", "b5-extraction-tables.html", "b6-evidence-lab.html", "b7-contradictions-and-stats.html", "b8-synthesis.html", "b9-qualitative-coding.html", "b10-capstone-memo.html"];
